...
private:
    ...
    static std::vector<H3Index> refineEndSegmentGradual(H3Index prevInPath, H3Index parentEnd, H3Index originalEnd,
                                                        int endRes);
    ...
    static std::vector<H3Index> findLocalPathAtResolution(H3Index start, H3Index end, H3Index limitParent);
    ...
    static H3Index cellToParentRes2(H3Index index);
};
